...
'''
 @brief Test unit for PtGreyFLIR
'''
class Test_PtGreyFLIR(unittest.TestCase, Test_main, TestData):
	...
	def setUp(self):
		...
		from src.DroneVision.DroneVision_src.hardware.PtGrey import PtGreyFLIR
		self.Settings 		= Settings
		self.PtGreyFLIR 	= PtGreyFLIR
		##################
	...
	def test_PtGreyCaptureFrame(self):
		...
		ptgrey 		= self.PtGreyFLIR.PtGreyFLIR(settings.GetSettings('CAMERA', 'camera_triggerPin'), \
