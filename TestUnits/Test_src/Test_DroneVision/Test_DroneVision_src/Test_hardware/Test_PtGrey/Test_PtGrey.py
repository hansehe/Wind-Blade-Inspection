...
'''
 @brief Test unit for PtGrey
'''
class Test_PtGrey(unittest.TestCase, Test_main, TestData):
	...
	def setUp(self):
		...
		from src.DroneVision.DroneVision_src.hardware.PtGrey import PtGrey
	...
	def test_PtGreyCaptureFrame(self):
		...
		ptgrey 		= self.PtGrey.PtGrey(settings.GetSettings('CAMERA', 'ptgrey_library'), settings.GetSettings('CAMERA', 'camera_triggerPin'), \
